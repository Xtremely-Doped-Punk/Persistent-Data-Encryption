...
public class DemoJSON : MonoBehaviour
{
    ...
    public void SerializeJson()
    {
        ...
        if (FileSystem.Save(PlayerStats, "player-stats.json",
            EncryptionEnabled ? FileSystem.EncrptionType.Aes : FileSystem.EncrptionType.None))
        {
            ...
            try
            {
                ...
                PlayerStats data = FileSystem.Load<PlayerStats>("player-stats.json",
                    EncryptionEnabled ? FileSystem.EncrptionType.Aes : FileSystem.EncrptionType.None);
